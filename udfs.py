...
c.register_function(volume, "IRIS_VOLUME", 
        ...
        st.subheader("Example snippet for importing data from S3 and Registering it as Table")
        st.code(
            """
df = dd.read_csv(
...
c.create_table("trip_data",df)
        ...
        st.subheader("Example snippet for importing data from github and Registering it as Table")
        st.code(
            """
